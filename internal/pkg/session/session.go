...
type SessionConfig struct {
	IdleTimeout     time.Duration `arg:"--session-idle-timeout,env:SESSION_IDLE_TIMEOUT" default:"168h" help:"Session idle timeout" placeholder:"DUR"`
	AbsoluteTimeout time.Duration `arg:"--session-abs-timeout,env:SESSION_ABS_TIMEOUT" default:"720h" help:"Session absolute timeout" placeholder:"DUR"`
