...
Global options:
  ...
  --maps-dir DIR         Directory for PMTiles map extracts (empty to disable) [env: MAPS_DIR]
  --maps-bbox BBOX       Bounding box for map extract (min_lon,min_lat,max_lon,max_lat) [default: 5.5,45.5,11.0,48.2, env: MAPS_BBOX]
